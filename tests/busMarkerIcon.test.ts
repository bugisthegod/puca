...
import { buildBusIconSpec, busOperatorMarkerClass } from "../src/hooks/busMarkerIcon";
...
describe("bus marker icon spec", () => {
  ...
  test("adds operator and stale classes, swaps to Púca art, and uses taller dimensions", () => {
    ...
    expect(spec.className).toBe("bus-marker bus-marker--buseireann bus-marker--stale");
