...
const EN = {
  ...
  "tour.welcome.body": "A live map for Ireland's trains and buses, with routes, stops, arrivals, and favourites. Quick tour — takes 20 seconds.",
  "tour.mode.title": "Switch mode",
  "tour.mode.body": "Switch between Train and Bus. In Bus mode, choose Dublin Bus, Bus Éireann, or Go-Ahead.",
  "tour.search.title": "Search",
  "tour.search.body": "Search trains between stations, or find buses by route, stop number, or stop name.",
  "tour.tap.title": "Tap a vehicle",
  "tour.tap.body": "Tap any vehicle for live details, delays, stops, and route context.",
  "tour.settings.title": "Settings & help",
  "tour.settings.body": "Change language, theme, compass, button side, install tips, or revisit this tour.",
  "tour.favs.title": "Save favourites",
  "tour.favs.body": "Star bus routes, bus stops, or train searches, then open them from here.",
  "tour.locate.title": "Locate me",
  "tour.locate.body": "Centre the map on your location to see nearby vehicles and stops. You're all set!",
...
const ZH: Record<Key, string> = {
  ...
  "tour.welcome.body": "爱尔兰列车与公交实时地图，支持线路、站点、到站与收藏。快速引导，20 秒搞定。",
  "tour.mode.title": "切换模式",
  "tour.mode.body": "在列车和公交间切换。公交模式下可选择 Dublin Bus、Bus Éireann 或 Go-Ahead。",
  ...
  "tour.settings.body": "切换语言、主题、指南针、按钮位置，查看安装提示，或重温引导。",
  "tour.favs.title": "保存收藏",
  "tour.favs.body": "收藏公交线路、公交站或列车搜索，下次可从这里直接打开。",
  "tour.locate.title": "定位我",
  "tour.locate.body": "将地图定位到你的位置，查看附近车辆和站点。一切准备就绪！",
