  ...
  return (
    <svg viewBox="0 0 512 512" width={size} height={size} fill="none" aria-hidden="true">
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M 184 218 L 214 244 L 184 270" stroke="#16161c" strokeWidth="18" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M 328 218 L 298 244 L 328 270" stroke="#16161c" strokeWidth="18" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M 240 318 L 272 318" stroke="#16161c" strokeWidth="14" strokeLinecap="round" />
    </svg>
  );
}
