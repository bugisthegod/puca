...
OUT = "/Users/abel/Documents/Code/IrishRailTracker/src/data/goahead-stops.json"
...
def main():
    # Step 1: collect route_ids for Go-Ahead Ireland
    ...
    print(f"Go-Ahead route_ids: {len(ga_route_ids):,}", file=sys.stderr)
    ...
    print(f"Go-Ahead trip_ids: {len(trip_ids):,}", file=sys.stderr)
